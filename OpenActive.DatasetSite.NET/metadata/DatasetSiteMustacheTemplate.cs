...
<!DOCTYPE HTML>
<!--
  OpenActive Dataset Site Template version 1.0.16, from https://unpkg.com/@openactive/dataset-site-template@1.0.16/dist/datasetsite-csp.mustache
  
  This HTML file must reference a self-hosted 'datasetsite.styles.v1.0.16.css' file, co-located with the rest
  of the static assets from the following archive:
  https://unpkg.com/@openactive/dataset-site-template@1.0.16/dist/datasetsite-csp.static.zip
-->
<!--
  Design: Identity by HTML5 UP
  html5up.net | @ajlkn
...
{{{jsonld}}}
    ...
    <!--
      This stylesheet href must reference a self-hosted 'datasetsite.styles.v1.0.16.css' file in
      the same directory as the other static assets sourced from the following archive:
      https://unpkg.com/@openactive/dataset-site-template@1.0.16/dist/datasetsite-csp.static.zip
    -->
    <link rel=""stylesheet"" href=""{{{staticAssetsPathUrl}}}/datasetsite.styles.v1.0.16.css"" crossorigin=""anonymous"">
...
<body id=""booking"" background=""{{backgroundImage.url}}"">
    <table class=""always-hidden"" bgcolor=""#FFFFFF"" width=""100%"" height=""500px""><tr><td align=""center"">
      ...
      <p>""staticAssetsPathUrl"" is currently set to ""{{staticAssetsPathUrl}}"", and this page has failed to access this file: <pre>{{staticAssetsPathUrl}}/datasetsite.styles.v1.0.16.css</pre></p>
      <p>Please ensure that the assets at this location exactly match those in
      <a href=""https://unpkg.com/@openactive/dataset-site-template@1.0.16/dist/datasetsite-csp.static.zip"">datasetsite-csp.static.zip version 1.0.16</a>.</p>
      <p></p>
