...
<!DOCTYPE HTML>
<!--
  OpenActive Dataset Site Template version 1.0.19, from https://unpkg.com/@openactive/dataset-site-template@1.0.19/dist/datasetsite.mustache
-->
<!--
...
<!DOCTYPE HTML>
<!--
  OpenActive Dataset Site Template version 1.0.19, from https://unpkg.com/@openactive/dataset-site-template@1.0.19/dist/datasetsite-csp.mustache
  
  This HTML file must reference a self-hosted 'datasetsite.styles.v1.0.19.css' file, co-located with the rest
  of the static assets from the following archive:
  https://unpkg.com/@openactive/dataset-site-template@1.0.19/dist/datasetsite-csp.static.zip
-->
<!--
  Design: Identity by HTML5 UP
  html5up.net | @ajlkn
...
{{{jsonld}}}
    ...
    <!--
      This stylesheet href must reference a self-hosted 'datasetsite.styles.v1.0.19.css' file in
      the same directory as the other static assets sourced from the following archive:
      https://unpkg.com/@openactive/dataset-site-template@1.0.19/dist/datasetsite-csp.static.zip
    -->
    <link rel=""stylesheet"" href=""{{{staticAssetsPathUrl}}}/datasetsite.styles.v1.0.19.css"" crossorigin=""anonymous"">
